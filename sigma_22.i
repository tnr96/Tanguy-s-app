# This script: Apply only one non-zero macrostress sig_22, by using Neumann BCs
[GlobalParams]
...
[Outputs]
  [out]
    ...
    execute_on = 'TIMESTEP_END'
    enable = false
file_base = /Users/tmr96/Documents/Automatic/simulation_results/erosion4/erosion4_sigma_22
  []
  [csv]
    type = CSV
    execute_on = 'TIMESTEP_END'
